...
public class ReportDAO extends Appointment {
    ...
    public static ObservableList<Report> getCountries() throws SQLException {
        ...
        String sqlCommand = "SELECT countries.Country, count(*) as countryTotal from customers inner join first_level_divisions on customers.Division_ID = first_level_divisions.Division_ID inner join countries.Country_ID = first_level_divisions.Country_ID where customers.Division_ID = first_level_divisions.Division_ID group by first_level_divisions.Country_ID order by count(*) desc";
